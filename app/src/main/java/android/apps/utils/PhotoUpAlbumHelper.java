...
public class PhotoUpAlbumHelper extends AsyncTask<Object, Object, Object> {
    ...
    private GetAlbumListInterface getAlbumListInterface;
...
//					imageItem.setThumbnailPath(thumbnailList.get(_id));
    ...
    protected void onPostExecute(Object result) {
        ...
        getAlbumListInterface.getAlbumList((List<PhotoUpImageBucket>) result);
    }


    public void setGetAlbumListInterface(GetAlbumListInterface getAlbumListInterface) {
        this.getAlbumListInterface = getAlbumListInterface;
    }

    public interface GetAlbumListInterface {
